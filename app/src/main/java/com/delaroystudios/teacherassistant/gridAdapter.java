...
import static com.delaroystudios.teacherassistant.R.*;
...
public class gridAdapter extends BaseAdapter{
    ...
    public View getView(int position, View v, ViewGroup parent) {
        if (v == null) {
            ...
            v = vi.inflate(layout.grid_layout, null);
        }
        TextView textView = (TextView)v.findViewById(id.namePlacer);
        ImageView imageView = (ImageView)v.findViewById(id.imageHolder);
        final MediaPlayer mp;
        mp = MediaPlayer.create(this, raw.Scroll);
        if(names.get(position).toString().equals("ATTENDANCE"))
        {
            imageView.setImageResource(drawable.ic_attendance);
        ...
        {
            imageView.setImageResource(drawable.ic_schedule);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
        ...
        {
            imageView.setImageResource(drawable.ic_notes);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
        ...
        {
            imageView.setImageResource(drawable.ic_profile);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
        ...
        else if(names.get(position).toString().equals("FIND CGPA"))
        {
            imageView.setImageResource(drawable.ic_cgpa);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
        ...
        else if(names.get(position).toString().equals("SUBJECTS"))
        {
            imageView.setImageResource(drawable.ic_subjects);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent launchinIntent = new Intent(activity, ActivitySubject.class);
                    activity.startActivity(launchinIntent);
                }
            });
            Animation anim = new ScaleAnimation(
    ...
    public static class createRequest extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            final View v = inflater.inflate(layout.pick_period, null);
            final DatePicker datePicker = (DatePicker) v.findViewById(id.datePicker);
            final EditText hour = (EditText)v.findViewById(id.periodID);
            final Spinner spn = (Spinner) v.findViewById(id.spinnerSubject);
...
//        notificationIntent.putExtra(MainListAdapter.IS_EMERGENCY, true);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(activity.getBaseContext())
                ...
                .setSmallIcon(drawable.ic_notes)
